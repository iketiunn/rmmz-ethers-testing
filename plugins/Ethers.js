...
// For real use case, provider should be a authenticated wallet
// const provider = new ethers.providers.EtherscanProvider('homestead', ''); // For testing with api provider, get the api key from https://etherscan.io/myapikey
...
// const contract = new ethers.Contract(contractAddress, abi, provider); // TODO: contract with default provider for testing
/** Get all NFT address from owner, and get all asset metadata one by one */
const somebodyAddress = '0x5f7Bd8E190D30b9Db5656749c745b8988aB69Cd0'
contract.balanceOf(somebodyAddress).then(async balance => {
  console.log('total balance:', balance)
  for (let i = 0; i < balance; i++) {
    const tokenId = await contract.tokenOfOwnerByIndex(somebodyAddress, i)
